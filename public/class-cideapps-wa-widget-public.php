...
class Cideapps_Wa_Widget_Public {
	...
	public function enqueue_scripts() {
		...
		wp_localize_script( $this->plugin_name, 'cwawSettings', array(
			...
			'buttonText' => isset( $settings['button_text'] ) ? $settings['button_text'] : __( 'Iniciar conversación', 'cideapps-wa-widget' ),
	...
	public function render_widget() {
		...
		$cta = isset( $settings['cta'] ) ? $settings['cta'] : '';
		$button_text = isset( $settings['button_text'] ) ? esc_html( $settings['button_text'] ) : __( 'Iniciar conversación', 'cideapps-wa-widget' );
		...
		<div id="cwaw-widget" class="cwaw-widget cwaw-position-<?php echo esc_attr( $position ); ?>" style="--cwaw-theme-color: <?php echo esc_attr( $theme_color ); ?>;">
			...
			<div id="cwaw-chat-window" class="cwaw-chat-window">
				...
				<div class="cwaw-chat-body">
					...
					<?php endif; ?>
					<a href="https://wa.me/<?php echo esc_attr( $telephone ); ?>?text=" id="cwaw-whatsapp-link" class="cwaw-whatsapp-button" target="_blank" rel="noopener">
