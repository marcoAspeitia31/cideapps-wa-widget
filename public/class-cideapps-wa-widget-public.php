...
class Cideapps_Wa_Widget_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Cideapps_Wa_Widget_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Cideapps_Wa_Widget_Loader will then create the relationship
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/cideapps-wa-widget-public.js', array( 'jquery' ), $this->version, false );
